    ...
    <section className='relative w-full min-h-screen flex flex-col justify-center items-center pt-20 pb-10 px-4'>
      ...
      >
        <div className='bg-[#e62525] border-4 border-black p-4 md:p-8 pixel-shadow inline-block transform -rotate-1'>
          <h1 className='text-2xl md:text-5xl text-white pixel-text-shadow leading-tight mb-2'>SERHII SERDIUK</h1>
          <h2 className='text-sm md:text-xl text-yellow-300 pixel-text-shadow'>SENIOR FRONTEND DEVELOPER</h2>
        </div>
      </motion.div>
        ...
        <div className='flex flex-col items-center justify-center space-y-4 order-2 md:order-1'>
          ...
          <div className='flex gap-4 mt-4'>
            <a
              ...
              className='bg-white p-3 border-4 border-black hover:bg-yellow-200 transition-colors cursor-pointer'
            >
            ...
            <a
              ...
              target='_blank'
              rel='noreferrer'
              className='bg-white p-3 border-4 border-black hover:bg-blue-200 transition-colors cursor-pointer'
            >
            ...
            <a
              ...
              target='_blank'
              rel='noreferrer'
              className='bg-white p-3 border-4 border-black hover:bg-gray-200 transition-colors cursor-pointer'
            >
