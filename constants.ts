import { Job, Education, Skill, ContactInfo } from './types';
...
export const SKILLS: Skill[] = [
  ...
  { name: 'Kotlin/Java', level: 40, category: 'Backend' },
...
export const EXPERIENCE: Job[] = [
  ...
  },
  {
    ...
    location: "Vinnytsya, Ukraine",
    description: [
      "Developed complex UI components.",
